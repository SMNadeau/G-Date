...
const lightColorSet = {
  ...
  mainThemeForegroundColor: '#a177cb',
...
const navThemeConstants = {
  ...
  dark: {
    ...
    headerStyleColor: invert('#801dd1'),
...
const _iconSet = {
  ...
  logo: require('../assets/images/GDateIcon.png'),
...
const _styleSet = {
  ...
  bottomLogoViewStyle300: {
    position: 'absolute',
    top: WINDOW_HEIGHT - 375,
    height: 300,
    width: 300,
  },
  bottomLogoViewStyle250: {
    position: 'absolute',
    zIndex: 5,
    top: WINDOW_HEIGHT - 325,
    height: 250,
    width: 250,
  },
  bottomLogoViewStyle200: {
    position: 'absolute',
    zIndex: 5,
    top: WINDOW_HEIGHT - 275,
    height: 200,
    width: 200,
  },
  logoImageStyle: {
    alignItems: 'center',
    /* styles the icon image to resize to fit inside its container: */
    flex: 1,
    resizeMode: 'contain',
    width: null,
    height: null,
